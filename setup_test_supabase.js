...
const testDir = path.join(appDir, 'test-supabase');
const testPage = path.join(testDir, 'page.tsx');
const libDir = path.join(root, 'lib');
const supabaseClient = path.join(libDir, 'supabaseClient.ts');
...
fs.writeFileSync(testPage, pageCode, 'utf8');
...
console.log('OK: page de test Supabase créée : app/test-supabase/page.tsx');
console.log('OK: .env.local ajouté/vérifié dans .gitignore');
console.log('Lance npm run dev puis ouvre http://localhost:3000/test-supabase');
