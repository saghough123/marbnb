...
export default function AdminDashboardPage() {
  ...
  async function chargerDashboard() {
    ...
    if (errors.length > 0) {
      setMessage("Erreur Supabase : " + errors.map((e) => e?.message).join(" | "));
    }
